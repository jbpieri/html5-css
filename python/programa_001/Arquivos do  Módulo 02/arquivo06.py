...
#   elif: Recurso do Python para solucionar esse problema de múltiplos if e else um dentro do outro.
#   O elif substitui um par de else e if, sem a necessidade de criar outro nível, ou outro bloco. Ou seja sem levar o código exageradamente para a direita,
...
elif quantM3Concreto <= 80:
    precoConcM3  = 270
    
elif quantM3Concreto <= 120:
    precoConcM3 = 240
